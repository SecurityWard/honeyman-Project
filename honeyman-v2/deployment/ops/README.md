...
# 3. Uptime probe
install -m 0755 honeyman-v2/deployment/ops/healthcheck.sh \
    /usr/local/sbin/honeyman-healthcheck.sh
install -m 0644 honeyman-v2/deployment/ops/honeyman-healthcheck.service \
    /etc/systemd/system/honeyman-healthcheck.service
install -m 0644 honeyman-v2/deployment/ops/honeyman-healthcheck.timer \
